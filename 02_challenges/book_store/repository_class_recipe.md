...
INSERT INTO books (title, author_name) VALUES ('book_1', 'author_1');
INSERT INTO books (title, author_name) VALUES ('book_2', 'author_2');
```
...
books[0].id # =>  "1"
books[0].title # =>  "book_1"
books[0].author_name # =>  "author_1"

books[1].id # =>  "2"
books[1].title # =>  "book_2
books[1].author_name # =>  "author_2"
```
